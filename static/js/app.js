...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadScenarios() {
        // Show loading state
        scenarioContainer.innerHTML = '<div class="col-12 text-center"><p>Loading scenarios...</p></div>';
        ...
        fetch('/api/scenarios')
            ...
            .catch(error => {
                ...
                scenarioContainer.innerHTML = '<div class="col-12 text-center"><p>Error loading scenarios. Please refresh the page.</p></div>';
            });
    }
    ...
    function deleteScenario(scenarioName) {
        ...
        .then(data => {
            if (data.success) {
                ...
                alert('Error deleting scenario: ' + (data.message || 'Unknown error'));
            }
        })
        .catch(error => {
